        ...
        match j["event"]:
            ...
            case "MissionRedirected" if "Mission_Massacre" in j["Name"]:
                ...
                emitter.emit(
                    ...
                    timestamp=logtime, loglevel=log,
                )
            ...
            case "Missions" if "Active" in j and not state.missions:
                ...
                for mission in j["Active"]:
                    ...
                    if "Mission_Massacre" in mission["Name"] and exp_ok:
                        ...
                        if "Reward" in mission and mission["MissionID"] not in state.mission_value_map:
                ...
                if state.active_missions:
                    ...
                    redirected = set()
                    try:
                        for jpath in sorted(journal_dir.glob("Journal*.log")):
                            try:
                ...
                emitter.emit(
                    ...
                    emoji="📋", sigil="*  MISS",
                    timestamp=logtime, loglevel=notify["MissionUpdate"],
                )
            ...
            case "MissionAbandoned" | "MissionCompleted" | "MissionFailed" if (
                ...
                emitter.emit(
                    msg_term=f"Massacre mission {event_name} (active: {len(state.active_missions)})",
                    emoji="📋", sigil="*  MISS",
                    timestamp=logtime, loglevel=notify["MissionUpdate"],
                )
