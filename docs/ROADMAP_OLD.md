...
### Three-UI Standardisation Pass  ✅ shipped
GTK4, TUI, and Electron blocks audited and aligned — Career detail tabs,
...
Contributed by [Maldor](https://github.com/Maldor) via [PR #2](https://github.com/maldor/EDMD/pull/2).
