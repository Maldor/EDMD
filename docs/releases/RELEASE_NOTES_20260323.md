...
> **This feature is marked experimental.** The installer has not been tested across a wide range of Windows configurations. Terminal mode and GUI mode are both functional. Please report issues via the [issue tracker](https://github.com/maldor/EDMD/issues).
