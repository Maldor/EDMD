...
; bash --login sources /etc/profile; the script then exports MSYSTEM=UCRT64
; and re-sources /etc/profile to switch into the UCRT64 environment.
...
begin
  ...
  try
    ...
    Script.Add('');
    Script.Add('# Force UCRT64 environment — equivalent to opening ucrt64.exe');
    Script.Add('export MSYSTEM=UCRT64');
    Script.Add('source /etc/profile');
    Script.Add('');
