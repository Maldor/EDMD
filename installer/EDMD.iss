...
begin
  ...
  try
    ...
    Script.Add('');
    Script.Add('MSYS2_ROOT="' + StringReplace(Ms2Root, '\', '/', [rfReplaceAll]) + '"');
    Script.Add('EDMD_APP="' + StringReplace(AppDir,   '\', '/', [rfReplaceAll]) + '"');
    Script.Add('EDMD_SRC="' + StringReplace(SrcDir,   '\', '/', [rfReplaceAll]) + '"');
    Script.Add('EDMD_CFG="' + StringReplace(CfgDir,   '\', '/', [rfReplaceAll]) + '"');
    Script.Add('');
